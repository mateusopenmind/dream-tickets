            ...
            {isLoading ? (
              ...
              <TableRow key={t.id}>
                ...
                <TableCell className="py-2">
                  <span className="font-mono text-xs text-muted-foreground">{t.remetente?.codigo}</span>
                  <span className="text-muted-foreground"> · {t.prog_remetente?.nome}</span>
                </TableCell>
                <TableCell className="py-2">
                  <span className="font-mono text-xs text-muted-foreground">{t.recebedora?.codigo}</span>
