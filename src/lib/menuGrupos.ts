...
export const GRUPOS_MENU: { label: string; chaves: string[] }[] = [
  { label: "Dashboard", chaves: ["dashboard", "dashboard_faturamento"] },
  ...
  { label: "Estoque", chaves: ["estoque_milhas", "estoque_compras", "estoque_transferencias", "promocoes", "estoque_perdas", "estoque_ajuste"] },
