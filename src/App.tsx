...
import { useAuth, useExpiracaoSessao, useSessaoUnica } from "@/hooks/useAuth";
...
import ConferenciaPixPage from "./pages/ConferenciaPixPage";
...
function AppRoutes() {
  ...
  // Sessão única: um login novo derruba as outras sessões do mesmo usuário
  // (ver lib/sessaoUnica.ts). Também só aqui, pelo mesmo motivo.
  useSessaoUnica(session);
  ...
  return (
    <AppLayout>
      <Routes>
        ...
        <Route path="/conferencia-pix" element={<ConferenciaPixPage />} />
