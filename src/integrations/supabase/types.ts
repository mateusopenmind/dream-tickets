...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      emissoes: {
        Row: {
          taxas_moeda: string | null
          taxas_valor_moeda: number | null
          taxas_cotacao: number | null
          taxas_real_moeda: string | null
          taxas_real_valor_moeda: number | null
          taxas_real_cotacao: number | null
          bagagens_moeda: string | null
          bagagens_valor_moeda: number | null
          bagagens_cotacao: number | null
          bagagens_real_moeda: string | null
          bagagens_real_valor_moeda: number | null
          bagagens_real_cotacao: number | null
          assentos_moeda: string | null
          assentos_valor_moeda: number | null
          assentos_cotacao: number | null
          assentos_real_moeda: string | null
          assentos_real_valor_moeda: number | null
          assentos_real_cotacao: number | null
          outros_moeda: string | null
          outros_valor_moeda: number | null
          outros_cotacao: number | null
          outros_real_moeda: string | null
          outros_real_valor_moeda: number | null
          outros_real_cotacao: number | null
          outros_tipo: string
          outros_real_tipo: string
      ...
      programa_moedas: {
        ...
        Relationships: [
          {
            foreignKeyName: "programa_moedas_moeda_id_fkey"
            columns: ["moeda_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "programa_moedas_programa_id_fkey"
            columns: ["programa_id"]
            isOneToOne: false
            referencedRelation: "programas"
            referencedColumns: ["id"]
      ...
      programas: {
        Row: {
          regra_aceita_reais: boolean
          created_at: string
          id: string
          nome: string
          observacao: string | null
          programa_estoque_id: string | null
          regra_ajuste_campo_aberto: boolean
          regra_ajuste_cupom: boolean
          regra_ajuste_desconto_promo: boolean
          regra_ajuste_hack_upgrade: boolean
          regra_ajuste_retarifacao: boolean
          regra_ajuste_retarifacao_outro_programa: boolean
          regra_ajuste_taxa_resgate: boolean
          regra_codigo_la: boolean
          regra_cpfs_otimizados: boolean
          regra_facial: boolean
          regra_milhas_fracionadas: boolean
          regra_percentual_cb: boolean
          regra_taxa_queima_cpf: boolean
