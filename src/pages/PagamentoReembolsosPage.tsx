...
export default function PagamentoReembolsosPage() {
  ...
  const confirmar = async () => {
    ...
    try {
      ...
      toast.success(`${contar(selecionados.size, "reembolso marcado", "reembolsos marcados")} como pago.`);
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        {!verPagos && selecionados.size > 0 && (
          <div className="flex items-center gap-2">
            <PagarPorPixButton tipo="reembolso" ids={[...selecionados]} />
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          <DialogHeader><DialogTitle>Marcar {contar(selecionados.size, "reembolso", "reembolsos")} como pago</DialogTitle></DialogHeader>
