...
export default function UsuariosPage() {
  ...
  // Admin e super admin resetam a senha de qualquer usuário (inclusive de outro admin).
  const resetSenha = async (u: any) => {
    if (!confirm(`Gerar nova senha temporária para ${u.nome} (${PAPEL_LABEL[u.papel] ?? u.papel})?\n\nA senha atual deixa de funcionar na hora e a pessoa terá que definir uma nova no próximo acesso.`)) return;
    try {
