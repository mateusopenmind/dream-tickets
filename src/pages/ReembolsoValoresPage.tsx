...
export default function ReembolsoValoresPage() {
  ...
  const confirmar = async () => {
    ...
    try {
      ...
      toast.success(`${contar(selecionados.size, "lançamento marcado", "lançamentos marcados")} como reembolsado no cartão.`);
  ...
  return (
    <div className="space-y-4">
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          <DialogHeader><DialogTitle>Marcar {contar(selecionados.size, "lançamento", "lançamentos")} como reembolsado no cartão</DialogTitle></DialogHeader>
