      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-lg">
          ...
          <div className="grid gap-3 py-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="grid gap-1"><Label>Milhas (por ciclo)</Label><Input type="number" min={0} value={form.milhas} onChange={(e) => set("milhas", e.target.value)} /></div>
              <div className="grid gap-1"><Label>Valor (R$)</Label><NumericInput decimal prefix="R$ " value={Number(form.valor) || 0} onChange={(n) => set("valor", String(n))} /></div>
            </div>
