...
import { useProgramas, useOperacoes, useOperacoesPerdas, useOperacoesCompras, useOrigens, useEmissores, useOrigensClientes, useBancos, useTaxasQueimaCpf, useUpsertTaxaQueimaCpf, useDeleteTaxaQueimaCpf } from "@/hooks/useData";
