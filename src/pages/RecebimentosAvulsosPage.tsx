        ...
        <DialogContent className="w-[95vw] max-w-3xl min-h-[min(70vh,520px)] max-h-[90vh] flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto space-y-4 py-2 pr-1">
            <div className="grid gap-2">
              ...
              />
              {!emissaoSelecionada && (
                <p className="text-xs text-muted-foreground">{(emissoesEmAberto ?? []).length} emissão(ões) em aberto disponível(is). Digite o ID, o localizador, o código ou o nome do cliente para filtrar.</p>
              )}
            </div>
