            ...
            <>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div className="grid gap-2"><Label>Taxas{form.tipo === "parcial" || form.tipo === "taxas" ? " (proporcional)" : ""}</Label><NumericInput value={form.cli_taxas} onChange={(n) => setField("cli_taxas", n)} decimal prefix="R$" placeholder="0,00" /></div>
